...
export function Quickstart() {
  return (
    <div>
      <DocH1>快速开始</DocH1>
      <DocLead>
        wait-monitor 服务端支持 Linux amd64 / arm64，提供一键脚本和已签名二进制两种公开部署方式。
      ...
      <CodeBlock code={'mv wait-linux-amd64 wait-monitor\nchmod +x wait-monitor\n./wait-monitor server'} title="直接运行（amd64 示例）" />
